...
class build_ext_biopython(build_ext):
    def run(self):
        ...
        if is_Numpy_installed():
            ...
            self.extensions.append(
                Extension('Bio.PDB.Fold.fold',
                          ['Bio/PDB/Fold/core/foldmodule.c',
                           'Bio/PDB/Fold/core/memory.c',
                           'Bio/PDB/Fold/core/debugutils.c',
                           'Bio/PDB/Fold/core/datautils.c',
                           'Bio/PDB/Fold/core/clutils.c',
                           'Bio/PDB/Fold/core/random.c',
                           'Bio/PDB/Fold/core/fileio.c',
                           'Bio/PDB/Fold/core/errorhandler.c',
                           'Bio/PDB/Fold/core/protein.c',
                           'Bio/PDB/Fold/core/rotation.c',
                           'Bio/PDB/Fold/core/distance.c',
                           'Bio/PDB/Fold/core/modules.c',
                           'Bio/PDB/Fold/core/simulation.c',
                           'Bio/PDB/Fold/modules/sampling/dsa.c',
                           'Bio/PDB/Fold/modules/energy/dopecb.c',
                           'Bio/PDB/Fold/modules/custom/rbasins.c',
                           'Bio/PDB/Fold/modules/custom/carg.c',
                           'Bio/PDB/Fold/modules/drivers/debug.c',
                           'Bio/PDB/Fold/modules/drivers/oops.c'],
                          include_dirs=[numpy_include_dir],
                          extra_compile_args=['-I/home/acolubri/NVIDIA_GPU_Computing_SDK/OpenCL/common/inc/'],
                          extra_link_args=['-Wl,-L/home/acolubri/NVIDIA_GPU_Computing_SDK/OpenCL/common/lib/Linux32/', '-Wl,-lOpenCL'],
                          ))
            self.extensions.append(
